...
(function() {
  jQuery(function() {
    ...
    ready = function() {
      ...
      $('#inputSpecialty').change(function() {
        var especialidade, optionsMedico;
        $('#atendimento_data').parent().hide();
        $('#atendimento_horario').parent().hide();
        ...
        if (optionsMedico) {
          ...
          return $('#atendimento_medico_id').parent().show();
        } else {
          $('#atendimento_medico_id').empty();
          return $('#atendimento_medico_id').parent().hide();
        }
      });
      $('#atendimento_medico_id').change(function() {
        var especialidade, filtro, medico, optionsData;
        $('#atendimento_horario').parent().hide();
        especialidade = $('#inputSpecialty :selected').text();
        ...
        if (optionsData) {
          ...
          return $('#atendimento_data').parent().show();
        } else {
          $('#atendimento_data').empty();
          return $('#atendimento_data').parent().hide();
        }
      });
      return $('#atendimento_data').change(function() {
        var data, especialidade, filtro, medico, optionsHorario;
        especialidade = $('#inputSpecialty :selected').text();
        medico = $('#atendimento_medico_id :selected').text();
        ...
        if (optionsHorario) {
          ...
          return $('#atendimento_horario').parent().show();
        } else {
          $('#atendimento_horario').empty();
          return $('#atendimento_horario').parent().hide();
        }
      });
    };
