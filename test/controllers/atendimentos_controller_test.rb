...
class AtendimentosControllerTest < ActionController::TestCase
  ...
  test "should create atendimento" do
    assert_difference('Atendimento.count') do
      post :create, atendimento: { data: @atendimento.data, horario: @atendimento.horario, particular: @atendimento.particular }
    end
  ...
  test "should update atendimento" do
    patch :update, id: @atendimento, atendimento: { data: @atendimento.data, horario: @atendimento.horario, particular: @atendimento.particular }
    assert_redirected_to atendimento_path(assigns(:atendimento))
  end
